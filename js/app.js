!(function () {
    ...
    $(window).on("resize", function () {
        ...
        function getCountryTo(way){
            ...
            return response.json();
                ...
                for(let i = 0; i < data.length; i++){
                    ...
                    way.innerHTML += `<option value=${data[i].id} id="toCountry">${fromState}</option>`;
                }
        ...
        let adultsCount = document.querySelector("#adultCount")
        let childrenCount = document.querySelector("#childCount")


        fromOneWay.addEventListener('change', (e)=>{
            fromOneWay = document.querySelector("#fromOneWay")
            fromOneWay = fromOneWay.options[fromOneWay.selectedIndex].getAttribute('value')
        })

        toOneWay.addEventListener('change', (e)=>{
            toOneWay = document.querySelector("#toOneWay")
            toOneWay = toOneWay.options[toOneWay.selectedIndex].getAttribute('value')
        })
        ...
        //     flyingFromListRounded = flyingFromListRounded.options[flyingFromListRounded.selectedIndex].getAttribute('value');
        //     flyingToListRounded = flyingToListRounded.options[flyingToListRounded.selectedIndex].getAttribute('value');
        ...
        //     })
        //     .then(res => res.json())
        //     .then(response => console.log(response[0].totalPrice))
        //     .catch(function(res){ console.log(res) })
        // })
